...
abstract final class CandidateMarketCatalog {
  ...
  static const List<String> firstNames = <String>[
    'Александр', 'Алексей', 'Алина', 'Алёна', 'Анастасия', 'Андрей', 'Анна',
    'Антон', 'Арина', 'Артём', 'Артур', 'Борис', 'Вадим', 'Валерия', 'Варвара',
    'Вера', 'Вероника', 'Виктор', 'Виктория', 'Влад', 'Владимир', 'Галина',
    'Георгий', 'Глеб', 'Даниил', 'Дарья', 'Денис', 'Диана', 'Дмитрий', 'Евгений',
    'Евгения', 'Егор', 'Екатерина', 'Елена', 'Иван', 'Илья', 'Ирина', 'Кирилл',
    'Ксения', 'Лев', 'Леонид', 'Лилия', 'Макар', 'Максим', 'Маргарита', 'Марина',
    'Мария', 'Марк', 'Матвей', 'Михаил', 'Надежда', 'Наталья', 'Никита', 'Олег',
    'Ольга', 'Павел', 'Полина', 'Роман', 'Светлана', 'Семён', 'Сергей', 'София',
    'Степан', 'Тамара', 'Татьяна', 'Тимур', 'Фёдор', 'Юлия', 'Юрий', 'Яна',
    'Ярослав', 'Амир', 'Арсен', 'Ринат', 'Майя', 'Элина', 'Роберт', 'Эмиль',
    'Камилла', 'Милана',
  ];

  static const List<String> lastNames = <String>[
    'Абрамов', 'Агапов', 'Акимов', 'Александров', 'Андреев', 'Анисимов',
    'Антонов', 'Баранов', 'Белов', 'Беляев', 'Богданов', 'Борисов', 'Быков',
    'Васильев', 'Виноградов', 'Власов', 'Волков', 'Воробьёв', 'Воронцов',
    'Гаврилов', 'Герасимов', 'Голубев', 'Горбунов', 'Громов', 'Гусев', 'Давыдов',
    'Данилов', 'Демидов', 'Денисов', 'Дмитриев', 'Дорофеев', 'Егоров', 'Елисеев',
    'Ершов', 'Ефимов', 'Жуков', 'Зайцев', 'Захаров', 'Зотов', 'Иванов', 'Ильин',
    'Карпов', 'Ким', 'Кириллов', 'Киселёв', 'Ковалёв', 'Комаров', 'Королёв',
    'Котов', 'Крылов', 'Кузнецов', 'Куликов', 'Лазарев', 'Лебедев', 'Макаров',
    'Мартынов', 'Матвеев', 'Мельников', 'Миронов', 'Михайлов', 'Морозов',
    'Наумов', 'Назаров', 'Никитин', 'Новиков', 'Орлов', 'Осипов', 'Павлов',
    'Панов', 'Петров', 'Поляков', 'Попов', 'Родионов', 'Романов', 'Руденко',
    'Рябов', 'Сафин', 'Семёнов', 'Сидоров', 'Смирнов', 'Соболев', 'Соколов',
    'Соловьёв', 'Сорокин', 'Степанов', 'Тарасов', 'Титов', 'Тихонов', 'Третьяков',
    'Фёдоров', 'Фомин', 'Фролов', 'Харитонов', 'Чернов', 'Шаров', 'Шестаков',
    'Щербаков', 'Юдин', 'Яковлев', 'Яшин',
  ];
  ...
  static List<Candidate> _generate({
    ...
    final safeCount = count < remainingUniqueNames ? count : remainingUniqueNames;
  ...
  static Candidate _candidate(int seed, int ordinal) {
    ...
    final role = isHr
        ...
        : EmployeeRole.values[
            (_roll(seed, 0, 2) + ordinal * 5) % EmployeeRole.values.length
          ];
    ...
    final salaryPosition =
        (skill + quality + autonomy + reliability) / 4 / 100;
    final salaryRaw =
    ...
    final lastName = lastNames[(nameIndex ~/ firstNames.length) % lastNames.length];
    ...
    return Candidate(
      ...
      languageIds: isHr ? const <String>[] : _languagesFor(role, grade, seed, ordinal),
      isHr: isHr,
    );
  }
  ...
  static List<String> _languagesFor(
    ...
    final pool = switch (role) {
      EmployeeRole.frontend => const <String>[
        'typescript', 'javascript', 'html_css', 'dart',
      ],
      EmployeeRole.backend => const <String>[
        'go', 'typescript', 'python', 'java', 'csharp', 'ruby', 'elixir',
        'scala', 'php', 'rust',
      ],
      ...
      EmployeeRole.qa => const <String>['typescript', 'python', 'java', 'csharp'],
      _ => const <String>[],
    };
    ...
    final start =
        (_roll(seed, 0, 31) +
            (ordinal ~/ EmployeeRole.values.length) * 3) %
        pool.length;
  ...
  static int _roll(int seed, int ordinal, int salt) {
    var value = (seed ^ (ordinal * 0x45d9f3b) ^ (salt * 0x27d4eb2d)) &
        0x7fffffff;
