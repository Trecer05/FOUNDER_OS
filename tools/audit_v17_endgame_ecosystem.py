...
checks = [
    ...
    ('lib/presentation/features/products/product_detail_screen.dart', 'StartCompanyResearch(', 'product detail R&D UI'),
    ...
    ('lib/domain/simulation/engine/game_engine.dart', '.clamp(0.015, 0.65)', 'R7 severe churn ceiling preserves monetization differentiation'),
